...
emotionSentimentAnal1 <- function (inText) {
  ...
  emotionClass <- classify_emotion(inText, algorithm="MAXENT", prior=1.0)
...
polaritySentimentAnal1 <- function (inText) {
  ...
  polarityClass <- classify_polarity(inText, algorithm="MAXENT")
