...
emotionSentimentAnal2 <- function (inText) {
  ...
  emotionClass <- classify_emotion(inText, algorithm="HMM", prior=1.0)
...
polaritySentimentAnal2 <- function (inText) {
  ...
  polarityClass <- classify_polarity(inText, algorithm="HMM")
